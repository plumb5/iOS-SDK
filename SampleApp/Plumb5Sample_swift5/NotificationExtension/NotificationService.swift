...
class NotificationService: UNNotificationServiceExtension {
    ...
    override func didReceive(_ request: UNNotificationRequest, withContentHandler contentHandler: @escaping (UNNotificationContent) -> Void) {
        ...
        if let bestAttemptContent = bestAttemptContent {
            ...
            bestAttemptContent.title =  bestAttemptContent.title.replacingOccurrences(of: "~A~", with: "")
             bestAttemptContent.subtitle =  bestAttemptContent.title.replacingOccurrences(of: "~A~", with: "")
             bestAttemptContent.body =  bestAttemptContent.title.replacingOccurrences(of: "~A~", with: "")
